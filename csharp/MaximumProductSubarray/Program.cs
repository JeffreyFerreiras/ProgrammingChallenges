...
namespace MaximumProductSubarray
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            var scenarios = new[]
            {
                new Scenario("Example 1", new[] { 2,3,-2,4 }, 6),
                new Scenario("Example 2", new[] { -2,0,-1 }, 0),
                new Scenario("All Negative even count", new[] { -2,-3,-4 }, 12),
                new Scenario("Single neg", new[] { -2 }, -2),
                new Scenario("With zero", new[] { 0,2 }, 2),
            };
