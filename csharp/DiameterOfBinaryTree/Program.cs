...
internal static class Program
{
    private static void Main()
    {
        ...
        var scenarios = new[]
        {
            ...
            (Name: "Left Skewed", Values: new int?[] { 1, 2, null, 3 }, Expected: 2),
            (Name: "Right Skewed", Values: new int?[] { 1, null, 2 }, Expected: 1),
            (Name: "Balanced", Values: new int?[] { 1, 2, 3, 4, 5, 6, 7 }, Expected: 4),
            (Name: "Deep Subtree", Values: new int?[] { 1, 2, 3, 4, null, 5 }, Expected: 4)
        };
