...
internal static class Program
{
    private static void Main()
    {
        ...
        var scenarios = new[]
        {
            ...
            (Name: "Example 2", Values: [1, 2], Expected: 1),
            (Name: "Edge: Single Node", Values: [7], Expected: 0),
            (Name: "Left Skewed", Values: [1, 2, null, 3, null, 4, null, 5], Expected: 4),
            (Name: "Right Skewed", Values: [1, null, 2, null, 3, null, 4, null, 5], Expected: 4),
            (Name: "Balanced", Values: [1, 2, 3, 4, 5, 6, 7], Expected: 4),
            (Name: "Deep Subtree", Values: [1, 2, 3, 4, null, 5, null, 6, null, 7], Expected: 5)
        };
