        ...
        */
        ...
        private static string Reverse(string toReverse, string s)
        {
            if (toReverse.Length == 0)
                return s;
            return Reverse(
                toReverse.Substring(0, toReverse.Length - 1),
                s + toReverse.Substring(toReverse.Length - 1)
            );
        }
        ...
        private static string ReverseWithStringBuilder(string toReverse, StringBuilder sb)
        {
            if (toReverse.Length == 0)
                return sb.ToString();
            return ReverseWithStringBuilder(
                toReverse.Substring(0, toReverse.Length - 1),
                sb.Append(toReverse.Substring(toReverse.Length - 1))
            );
        }
