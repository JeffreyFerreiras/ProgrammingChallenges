...
internal static class Program
{
    private static void Main()
    {
        ...
        var scenarios = new[]
        {
            ...
            (Name: "Mixed", Values: [5, 4, 8, 11, null, 13, 4, 7, 2, null, null, 5, 1], Expected: 48),
            (Name: "Skewed", Values: [1, 2, null, 3, null, 4], Expected: 10),
            (Name: "Balanced", Values: [2, -1, -2, 3, 4, -5, 6], Expected: 8)
        };
