...
uint output = 0b_00111001011110000010100101000000;
uint result = ReverseBits(n);
Console.WriteLine($"{PrintBinary(n)} -> {PrintBinary(output)} = {PrintBinary(result)}");
...
{
    return Convert.ToString(n, toBase: 2);
}
